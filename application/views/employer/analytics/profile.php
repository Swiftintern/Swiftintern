...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Profile Analytics</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <form class="form-inline" role="form" id="profile_analytics_form">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div id="profile_reach">Select an opportunity and date range and then click on view analytics button to show details.</div>
                </div>
            </div>
        </div>
    </div>
