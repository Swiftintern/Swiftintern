...
use LinkedIn\Exceptions\LinkedInApiException;
use LinkedIn\Exceptions\LoginError;
use LinkedIn\Http\GuzzleRequest;
use LinkedIn\Http\RequestInterface;
use LinkedIn\Http\UrlGenerator;
use LinkedIn\Http\UrlGeneratorInterface;
use LinkedIn\Storage\DataStorageInterface;
use LinkedIn\Storage\SessionStorage;
use LinkedIn\Storage\IlluminateSessionStorage;
...
class LinkedIn
{
    ...
    /**
     * @var \LinkedIn\Http\RequestInterface request
     *
     */
    protected $request;
